  ...
  return (
    <div className='py-10 md:py-14 lg:py-16'>
      ...
      <p className='text-lg text-black dark:text-white py-5'>
        Hi, I'm a Full-Stack Developer based in Mangalore, India. I create cool web applications using ReactJs, Redux, Saga, TailwindCSS and Javascript in Front-End, NodeJs, ExpressJs, MongoDB, Postgres, Heroku and AWS in Back-End. I enjoy creating things that live on internet.
      </p>
