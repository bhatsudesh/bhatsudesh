    ...
    <>
      <div className="flex justify-between items-center py-6 md:py-9 lg:py-11 text-black dark:text-white">
        ...
        <div className="flex gap-4 md:gap-6 lg:gap-8 items-center font-light text-sm md:text-base lg:text-lg">
          <Link id="experience" onClick={() => sendEvent('Button', 'Click', 'experience_click')} to="experience" className="cursor-pointer" smooth={true} duration={1000}>Experience</Link>
          <a
          ...
          <div id="light" onClick={toggleMode} className="dark:hidden cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="text-gray-700 w-6">
          ...
          <div id="dark" onClick={toggleMode} className="hidden dark:flex cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="text-orange-300 w-7">
