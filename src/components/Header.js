    ...
    <>
      <div className="flex justify-between items-center py-6 md:py-9 lg:py-11 text-black dark:text-white">
        ...
        <div className="flex gap-4 md:gap-6 lg:gap-8 items-center font-light text-sm md:text-base lg:text-lg">
          <Link onClick={() => sendEvent('Button', 'Click', 'experience_click')} to="experience" className="cursor-pointer" smooth={true} duration={1000}>Experience</Link>
          <a
          ...
          <div onClick={toggleMode} className="dark:hidden cursor-pointer">
          ...
          <div onClick={toggleMode} className="hidden dark:flex cursor-pointer">
